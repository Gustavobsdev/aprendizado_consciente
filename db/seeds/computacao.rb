...
TextParagraph.create!(
  order: 3,
  content: content,
  text: 'O termo computador foi sendo atribuído as pessoas que manuseavam ferramentas de calcular em geral, ou seja, o primeiro computador foi uma calculadora. E surgiu a quase 2000 anos atrás. Porém, ao invés de fazer contas [aritméticas](/contents/sintese_matematica), ela era usada para prever posições astronômicas e eclipses.'
)
TextParagraph.create!(
  order: 4,
  content: content,
  text: 'A ***máquina de Anticítera*** como é conhecida, surgiu na Grécia antiga e dentre as suas principais funções estava a de calendário e também era usada na astrologia (pseudociência na qual as posições dos astros no dia do nascimento influenciam na personalidade da pessoa (diferente das digitais) e fazia uso de rodas e engrenagem para realizar as operações fundamentais: soma e subtrações (multiplicação e divisão só eram realizadas por repetição). A La pascaline foi planejada em 1642, porém só em 1820 houve a comercialização em larga escala de um modelo um pouco mais avançado criada por Thomas Charles de Colmar.).  Na direita temos o esquema da máquina e na direita sua maior engrenagem (de aprox. 140 mm de diâmetro).'
)
ImageParagraph.create!(
  order: 5,
  content: content,
...
[Síntese da Matemática](/contents/sintese_matematica)
'
)
